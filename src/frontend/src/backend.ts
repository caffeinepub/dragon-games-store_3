...
import type { ExternalBlob as _ExternalBlob, Game as _Game, Platform as _Platform, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addGame(arg0: Game): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addGame(await to_candid_Game_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGamesByPlatform(arg0: Platform): Promise<Array<Game>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGamesByPlatform(to_candid_Platform_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOnSaleGames(): Promise<Array<Game>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOnSaleGames();
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateGame(arg0: string, arg1: Game): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGame(arg0, await to_candid_Game_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Game_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Game): Promise<Game> {
...
async function from_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Game]): Promise<Game | null> {
    return value.length === 0 ? null : await from_candid_Game_n16(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        platform: from_candid_Platform_n18(_uploadFile, _downloadFile, value.platform),
        trailerVideoUrl: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.trailerVideoUrl)),
...
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pc" in value ? Platform.pc : "ps4" in value ? Platform.ps4 : "ps5" in value ? Platform.ps5 : "xbox" in value ? Platform.xbox : value;
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Game>): Promise<Array<Game>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Game_n16(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Game_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Game): Promise<_Game> {
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        trailerVideoUrl: value.trailerVideoUrl ? candid_some(value.trailerVideoUrl) : candid_none(),
